  ...
  return (
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        ...
        <div className="w-full lg:w-6/12">
          <h2 className="w-full text-end font-bold lg:text-4xl text-3xl lg:leading-10 leading-9 text-blue-600">
            رؤية نادي زاركي للمناظرات
          </h2>
          <p className="font-normal text-3xl leading-10 text-gray-600 mt-6 text-right">
            انطلاق من دور تمكين الشباب من المشاركة في الحياة المجتمعية وايصال
            صوت الشباب إلى صناع القرار وترسيخ ثقافة الحوار وتقبل الرأي والرأي
            الاخر واثراء النقاشات العلمية والسياسية والمجتمعية في الاوساط
            الشبابية بصورة عامة وشباب الزرقاء بصورة خاصة من خلال استخدام فن
            المناظرة وتبني ثقافة الحوار وسيعمل النادي على تدريب الشباب واليافعين
            على مفهوم المناظرة و اُسسها ، التي تمكن الشباب من الوقوف التحدث امام
            الجمهور وتقديم أفكارهم بطرق منظمة و مبنية على معرفة وأبحاث من مختلف
            المجالات بالإضافة إلى تثقيف الشباب حول سبل الاتصال التواصل و التفكير
            الناقد و تعزيز ثقافة الحوار عند الشباب.
          </p>
        </div>
      </div>
      ...
      <div className="relative mt-24">
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          <div className="z-20 w-12 h-12 bg-blue-600 rounded-full flex justify-center items-center">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
      ...
      <div className="sm:hidden block relative mt-8">
        ...
        <hr className="z-10 absolute top-2/4 w-full bg-blue-600" />
      </div>
